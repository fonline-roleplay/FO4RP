...
int TestDirect3d(uint test_type)
{
    ...
    switch(test_type)
    {
        ...
        case 2:
        {
            ...
            {
                {0.0,    0.0,    0.0, D3DCOLOR_ARGB(0xff, 0xff, 0, 0)},
                {cos(xqwe),    sin(xqwe),  0.0, D3DCOLOR_ARGB(0xff, 0xff, 0, 0)}
                //{10.0,  10.0,  0.0, D3DCOLOR_ARGB(0xff, 0xff, 0, 0xff)},
                //{300.0,  300.0,    1.0, D3DCOLOR_ARGB(0xff, 0xff, 0, 0xff)}
            };
            ...
            d3dDevice->DrawPrimitiveUP(D3DPT_LINELIST, 2, (void*)Vertices, sizeof(CUSTOMVERTEX));
