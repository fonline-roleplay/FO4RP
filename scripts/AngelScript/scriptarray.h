...
public:
	...
	asBYTE* GetBuffer() {return buffer->data;}
...
protected:
	...
	virtual void  CreateBuffer(SArrayBuffer **buf, asUINT numElements);
	virtual void  DeleteBuffer(SArrayBuffer *buf);
	virtual void  CopyBuffer(SArrayBuffer *dst, SArrayBuffer *src);
	virtual void  Construct(SArrayBuffer *buf, asUINT start, asUINT end);
	virtual void  Destruct(SArrayBuffer *buf, asUINT start, asUINT end);
